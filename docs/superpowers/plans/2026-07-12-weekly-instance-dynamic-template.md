...
- [ ] **Step 1: Write failing ISO boundary and configuration tests**
...
- [ ] **Step 3: Implement ISO week calculation**
...
- [ ] **Step 4: Add weekly instance fields and disabled-by-default schedule**
...
- [ ] **Step 5: Remove coordinate defaults and retain aliases only**
...
- [ ] **Step 7: Commit ISO and configuration changes**
...
- [ ] **Step 1: Update reporter tests to require dynamic discovery**
...
- [ ] **Step 2: Run reporter/content tests and verify they fail**
...
- [ ] **Step 3: Discover the copied instance map before content generation**
...
- [ ] **Step 5: Commit dynamic reporter integration**
