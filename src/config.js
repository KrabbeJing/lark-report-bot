...
export const WEEKLY_INSTANCE_FIELD_KEYS = {
  ...
  periodStart: '日报周期开始',
  periodEnd: '日报周期结束',
  aiInitialAt: 'AI初次生成时间',
  aiRefreshAt: 'AI刷新时间',
  aiDraftSnapshot: 'AI草稿快照',
  aiEvidenceSnapshot: 'AI证据快照',
  aiGenerationStatus: 'AI生成状态',
  ownerNotificationStatus: '负责人通知状态',
  ownerNotificationDetails: '负责人通知明细',
  ownerNotificationAt: '负责人通知时间',
  coreMetricReminderDetails: '核心指标提醒明细',
  posterImageKey: '海报ImageKey',
  posterStatus: '海报状态',
  posterSentAt: '海报发送时间',
  smallTeamPushStatus: '小群推送状态',
  smallTeamPushDetails: '小群推送明细',
  lastErrorSummary: '最后错误摘要',
  weekStart: '周开始日期',
  weekEnd: '周结束日期',
...
export const WEEKLY_SHEET_ENTITY_ALIASES = {
  ...
  management: {
    零售大众客群经营: ['零售大众客群', '零售', '大众客群', '客群经营', '营销活动'],
...
function normalizeWeeklySheetConfig(sheet) {
  ...
  return {
    ...
    titlePattern: sheet.titlePattern || '数字金融部周报{{reportDateMMDD}}',
